...
@method('PUT')
    ...
    <div class="modal-body">           
        <div class="form-body">
            ...
            <div class="form-group">
                <label>Address</label>
                <textarea class="form-control" id="eAddress" name="address" rows="3">{{$data->address}}</textarea>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick="saveDataUpdateTD({{$data->id}})">Edit</button>
